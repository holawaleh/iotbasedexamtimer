...
const ProjectBrief = () => {
  return (
    <div className="w-full max-w-2xl mx-auto py-6">
      <div className="bg-slate-800/50 border border-slate-700 rounded-3xl p-8 shadow-sm relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 gap-6 text-sm text-slate-300 leading-relaxed">
          <p>
